...
router.get('/game/:id', requireToken, (req, res, next) => {
...
router.patch('/game/:id', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/game/:id', requireToken, (req, res, next) => {
	Game.findById(req.params.id)
		.then(handle404)
		.then((game) => {
